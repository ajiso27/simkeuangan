...
class Cetak extends CI_Controller{
    ...
    function cetak_laporan($id){
      ...
      $pdf = new FPDF('p','mm','A4');
       ...
       $pdf->Cell(3,5,'',0,1);
       $pdf->Image(base_url().'assets/dist/img/jbr.png', 177, 10,29);
       $pdf->Image(base_url().'assets/dist/img/smk.png', 2, 10,29);
       $pdf->Cell(3,-5,'',0,1);
       $pdf->SetFont('TIMES','B',16);
       $pdf->Cell(192, 7, 'SMK INSAN MANDIRI', 0, 1, 'C');
       $pdf->Cell(189, 7, 'KABUPATEN BANDUNG BARAT', 0, 1, 'C');
       $pdf->SetFont('TIMES','',12);
       $pdf->Cell(189, 5, 'Jalan Sariwangi No.81, Bandung Barat', 0, 1, 'C');
       $pdf->Cell(189, 5, 'Telp.(022) 6645951,Fax(022)6645951', 0, 1, 'C');
       $pdf->Cell(189, 5, 'E-mail : smkinsanmandiri2013@gmail.com', 0, 1, 'C');
       $pdf->SetLineWidth(1);
...
foreach($data['pengeluaran'] as $r){
       ...
       $pdf->Cell(125, 35, '', 0, 1);
       $pdf->Cell(125, 35, '', 0, 0);
       $pdf->Cell(55, 5, 'Bandung Barat, '.tanggal(waktu(),'bulan'), 0, 1);
       $pdf->Cell(125, 5, '', 0, 0);
       $pdf->Cell(35, 5, 'Kepala Sekolah,', 0, 1);
       $pdf->Cell(125, 10, '', 0, 0);
       $pdf->Cell(35, 14, '', 0, 1);
       $pdf->Cell(125, 8, '', 0, 0);
       $pdf->Cell(35, 9, 'Zaenal Mutaqin, M.Pd.', 0, 0);
       $pdf->Output();  
    }
    ...
    function Cetak_periode(){
       ...
       $pdf->Image(base_url().'/assets/dist/img/j.png', 2, 10,33);
       $pdf->Cell(3,-5,'',0,1);
       $pdf->SetFont('TIMES','B',14);
       $pdf->Cell(189, 5, 'SMK INSAN MANDIRI', 0, 1, 'C');
       $pdf->Cell(189, 7, 'KABUPATEN BANDUNG BARAT', 0, 1, 'C');
       $pdf->SetFont('TIMES','B',16);
       $pdf->Cell(192, 7, 'SMK INSAN MANDIRI', 0, 1, 'C');
       $pdf->SetFont('TIMES','',12);
