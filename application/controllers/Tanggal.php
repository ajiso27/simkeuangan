...
class Tanggal extends CI_Controller {
	...
	public function index(){
		...
		$this->breadcrumb->append_crumb($this->parents.'Kalender',$this->parents);

		$data['title']	= $this->parents.' Kalender Pendidikan | SIM Sekolah ';
		$data['judul']	= $this->parents.' Kalender Pendidikan';
		$data['icon']	= $this->icon;
