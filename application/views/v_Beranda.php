    ...
    <div class="box box-primary">
        ...
        <div class="box-body text-center">
            <div class="jumbotron jumbotron-fluid" style="background-color:white;">
                <div class="container">
                 	<img style="width: 15%" src="<?=base_url('assets/dist/img/smk.png')?>">
                    <h2 class="display-4" style="color:#0066ff;">SISTEM INFORMASI MANAJEMEN KEUANGAN</h2>
                    <p class="lead" style="color:#66a3ff ">SMK INSAN MANDIRI</p>
                </div>
            </div>
