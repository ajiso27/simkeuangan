...
<a href="<?=base_url('Beranda')?>" class="logo">
    <span class="logo-mini"><b>SMK</b>Insan Mandiri</span>
    <span class="logo-lg"><b>SMK</b>   Insan Mandiri</span>
</a>
        ...
        <ul class="nav navbar-nav">
            <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <img src="<?php echo base_url('assets/dist/img/smk.png')?>" class="user-image" alt="User Image">
                    <span class="hidden-xs"> <?php echo $masuk['name']?></span>
                </a>
                <ul class="dropdown-menu">
                    <li class="user-header">
                        <img src="<?php echo base_url('assets/dist/img/smk.png')?>" class="img-circle" alt="User Image">
